...
o4Group.setLifetimeEach (-1);
coinsGroup.setLifetimeEach (-1);
climbersGroup.setLifetimeEach (-1);
invisilbeclimbersGroup.setLifetimeEach (-1);
tower.velocityY=0;
girl.velocityY=0;
coinsGroup.setVelocityEach (0,0);
o1Group.setVelocityEach (0,0);
o2Group.setVelocityEach (0,0);
o3Group.setVelocityEach (0,0);
o4Group.setVelocityEach (0,0);
climbersGroup.setVelocityEach (0,0)
invisilbeclimbersGroup.setVelocityEach (0,0)
...
function Spawnclimber(){
    if (frameCount%600===0){
        ...
        coin.lifetime=600
     coin.debug = true ;
     coin.setCollider("circle",-20,-30,30);
        coinsGroup.add(coin)
...
function reset(){
    ...
    invisilbeclimbersGroup.destroyEach();
